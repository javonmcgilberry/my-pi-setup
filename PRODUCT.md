...
6. **Give each command one job.** Native Pi commands own routine package updates, setup sync owns validation and application, and publishing Prewalk stays an explicit separate action.
